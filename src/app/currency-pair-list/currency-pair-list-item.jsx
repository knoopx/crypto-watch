    ...
    return (
      <div className="flex flex-auto justify-center items-center pa3 ba b--light-gray" >
        <div className="mr4 tr">
          ...
          <ColorIndicator className="f6" value={pair.percentChange(2)}>
            <Blink>{symbolize((pair.percentChange(2) * 100).toFixed(2))}%</Blink>
          </ColorIndicator>
          <ColorIndicator className="f6" value={pair.percentChange(pair.candles.size)}>
            <Blink>{symbolize((pair.percentChange(pair.candles.size) * 100).toFixed(2))}%</Blink>
          </ColorIndicator>
